...
const opening_questions = ['什么是Aether LLMOps?', '我想创建一个应用', '能介绍下什么是RAG吗?']
      ...
      >
        <div class="mb-9">
          ...
          <div class="text-base text-gray-700">
            说出你的创意，我可以快速帮你创建专属应用，一键轻松分享给朋友，也可以一键发布到Aether 
            LLMOps 平台、微信等多个渠道。
          </div>
        </div>
        <!-- 开场AI对话消息 -->
        <div class="flex gap-2">
          ...
          <div class="flex flex-col items-start gap-2">
            ...
            >
              <div class="font-bold">你好，欢迎来到Aether LLMOps🎉</div>
              <div class="">
                Aether LLMOps是新一代大模型 AI 应用开发平台。无论你是否有编程基础，都可以快速搭建出各种
              ...
              <div class="">如果你还有其他Aether LLMOps使用问题，也欢迎随时问我！</div>
            </div>
            <!-- 开场白建议问题 -->
