    ...
    "list": [
      {
        ...
        "description": "这是专门用来存储Aether-LLMOps信息的知识库",
        "document_count": 13,
        "icon": "https://aether-llmops-1257184990.cos.ap-guangzhou.myqcloud.com/2024/04/07/96b5e270-c54a-4424-aece-ff8a2b7e4331.png",
        "id": "c0759ca8-2d35-4480-83a8-1f41f29d1401",
        "name": "Aether-LLMOps知识库",
...
- **响应示例**：
  ...
  ```json
  {
    ...
    "data": {
      ...
      "name": "Aether-LLMOps聊天机器人",
      "icon": "https://aether-llmops-1257184990.cos.ap-guangzhou.myqcloud.com/2024/04/23/e4422149-4cf7-41b3-ad55-ca8d2caa8f13.png",
      "description": "这是一个Aether-LLMOps的Agent应用",
      "status": "published",
...
- **请求示例**：
  ...
  {
  	"name": "LLM应用产品经理",
  	"icon": "https://cdn.aether.com/2024/05/14/218e5217-ab10-4634-9681-022867955f1b.png",
      ...
      "datasets": [
        {
          ...
          "name": "Prompt提示词大全",
          "icon": "https://aether-llmops-1304251364.cos.ap-guangzhou.myqcloud.com/2024/10/27/67c94d7b-c503-4528-87c4-1810c17689b1.jpg"
        },
        {
          "id": "f3f28f75-8e60-4eba-b6df-4d1b390bbd89",
          "name": "Aether-LLMOps项目",
          "icon": "https://aether-llmops-1304251364.cos.ap-guangzhou.myqcloud.com/2024/09/29/9f5e42d4-e184-4e2c-88f2-0ef843749e3f.jpg"
        }
      ],
      "retrieval_config": {
...
- **响应示例**：
  ...
  ```json
  {
    "code": "success",
    "data": {
      "summary": "人类自我介绍为Wissfi，并要求人工智能解释LLM（大型语言模型）的概念。人工智能将LLM描述为一种基于深度学习的模型，通常建立在Transformer架构上，用于自然语言处理任务。LLM经历了一个预训练阶段，在那里他们从大量的文本数据中学习语言结构，比如维基百科的文章和书籍。它们利用自我注意机制来有效地处理长程依赖关系。经过预训练后，LLM可以针对特定的应用程序进行微调，使其功能适应文本生成、理解和分类等任务。LLM由于其多功能性和强大的语言理解和生成能力，被广泛应用于虚拟助理、翻译、情绪分析、医疗保健、金融等领域，代表了自然语言处理的前沿技术。"
    },
    "message": ""
  }
  ```
      ...
      "list": [
        {
          ...
          "name": "高德工具包",
          "icon": "https://cdn.aether.com/gaode.png",
...
- **请求示例**：
  ...
  {
    "name": "谷歌搜索",
    "icon": "https://cdn.aether.com/google.png",
...
- **响应示例**：
  ...
  ```json
  {
    "code": "success",
    "data": {
      "image_url": "https://cdn.aether.com/2024/05/14/218e5217-ab10-4634-9681-022867955f1b.png"
    },
    "message": ""
  }
  ```
      ...
      "list": [
        {
          "id": "46db30d1-3199-4e79-a0cd-abf12fa6858f",
          "name": "Aether-LLMOps知识库",
          "icon": "https://cdn.aether.com/dataset.png",
...
- **请求示例**：
  ...
  {
    "name": "Aether-LLMOps知识库",
    "icon": "https://cdn.aether.com/dataset.jpg",
    "description": "Useful for when you want to answer queries about the Aether-LLMOps知识库"
  }
  ```
...
- **响应示例**：
  ...
  ```json
  {
    ...
    "data": {
      ...
      "name": "泽辉呀",
      "email": "zehuiya@163.com",
      "avatar": "https://cdn.aether.com/2024/05/14/218e5217-ab10-4634-9681-022867955f1b.png",
...
- **请求示例**：
  ...
  {
      "is_active": true,
      "remark": "Aether-网LLMOps项目API秘钥信息"
  }
  ```
...
- **接口说明**：该接口主要用于与 LLMOps 辅助 Agent 进行 Chat 对话，接口为流式事件输出，辅助 Agent 拥有一个挂载在本地文件的向量数据库，并绑定 `创建Agent工具`，该 Agent 主要用来辅助学习+项目使用（例如教学 LLMOps 要怎么使用、特定知识点讲解等），接口的响应数据格式和 `调试会话` 保持一致。
